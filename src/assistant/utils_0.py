...
@traceable
def setup_qdrant_client(*args, **kwargs):
    print("QDrant client not available - using placeholder")
    return None

@traceable
def get_embeddings_model(*args, **kwargs):
    print("Embeddings model not available - using placeholder")
    return None

@traceable
def query_qdrant(*args, **kwargs):
    print("QDrant search not available - using placeholder")
    return {"results": []}